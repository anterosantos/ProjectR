...
import { RetificarTokenClient } from './_components/retificar-token-client'

interface RetificarTokenPageProps {
...
export default async function RetificarTokenPage({ params }: RetificarTokenPageProps) {
  ...
  return (
    <div className="flex flex-col gap-8 p-4 lg:p-6 max-w-2xl mx-auto">
      ...
      <RetificarTokenClient token={token} playerName={playerName} />
    </div>
  )
}
