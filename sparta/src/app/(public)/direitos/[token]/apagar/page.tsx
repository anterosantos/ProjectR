...
import { ApagarTokenClient } from './_components/apagar-token-client'

interface ApagarTokenPageProps {
...
export default async function ApagarTokenPage({ params }: ApagarTokenPageProps) {
  ...
  return (
    <div className="flex flex-col gap-8 p-4 lg:p-6 max-w-2xl mx-auto">
      ...
      <ApagarTokenClient token={token} playerName={playerName} />
    </div>
  )
}
