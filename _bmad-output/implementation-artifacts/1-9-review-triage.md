...
- **Location:** `project-r/src/proxy.ts:46-62`
...
- **Severity:** CRITICAL
- **Source:** edge
- **Location:** `project-r/src/app/page.tsx:16-20` and `project-r/src/app/(staff)/layout.tsx:711-715`
...
- **Severity:** HIGH
- **Source:** blind+auditor
- **Location:** `project-r/src/proxy.ts:52-62` (enforcer) vs `project-r/src/app/page.tsx:25-31` (page-level)
...
- **Severity:** MEDIUM
- **Source:** blind
- **Location:** `project-r/src/components/patterns/BottomTabNav.tsx:37-40`
...
- **Severity:** MEDIUM
- **Source:** blind
- **Location:** `project-r/src/components/patterns/BottomTabNav.tsx:47`
...
- **Severity:** MEDIUM
- **Source:** blind
- **Location:** `project-r/src/proxy.ts:59`
...
- **Severity:** MEDIUM
- **Source:** auditor
- **Location:** `project-r/src/app/(staff)/layout.tsx:729`
...
- **Severity:** MEDIUM
- **Source:** auditor
- **Location:** `project-r/src/components/patterns/StaffSidebar.tsx:1-20`
...
- **Severity:** MEDIUM
- **Source:** blind
- **Location:** `project-r/src/proxy.ts:45-50`
...
- **Severity:** MEDIUM
- **Source:** blind
- **Location:** `project-r/src/proxy.ts:37-40`
...
- **Severity:** LOW
- **Source:** blind
- **Location:** `project-r/src/app/(staff)/layout.tsx:711-720`
...
- **Severity:** LOW
- **Source:** blind
- **Location:** `project-r/src/components/patterns/BottomTabNav.test.tsx:939-942`
