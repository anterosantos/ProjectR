...
> **Accepted on:** 2026-05-09 (via Project R organization signup ToS acceptance)
...
| Role | Entity | Contact |
|------|--------|---------|
| **Data Controller** | Antero Santos (sole proprietor — Project R) | antero.rsantos@gmail.com |
...
**Purpose:** Hosting and processing of personal and health data for the Project R athlete performance management application — a youth football club platform tracking fatigue, readiness, and performance metrics for athletes aged 13–18.
...
Project R additionally enforces (controller-side, on top of processor measures):
...
Project R commits to facilitating:
...
Supabase commits to notifying Project R **without undue delay** (target ≤24h) upon discovering a breach affecting personal data.

Project R commits to notifying the supervisory authority (CNPD — Comissão Nacional de Proteção de Dados, Portugal) within 72 hours where required by Art. 33 GDPR.
...
This DPA enters into force upon signature and remains in effect for the duration of the Master Service Agreement between Project R and Supabase. Survival clauses (data deletion, audit obligations) extend post-termination per Supabase's published terms.
...
**If/when upgrading to Pro plan:** request a counter-signed DPA via support@supabase.com with subject "DPA execution request — Project R organization" and attach a copy of the standard text. Update this section with the signed PDF reference.
