...
| Controller | Antero Santos (Project R) |
...
Project R is a Progressive Web App for youth football clubs (sub-14 to senior amateur) enabling staff to monitor athlete fatigue, training load, and performance through a single integrated platform.
...
- **Project R PRD:** `_bmad-output/planning-artifacts/prd.md`
- **Project R DPA:** `./dpa.md`
