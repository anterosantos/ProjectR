...
<body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;color:#171717;">
  ...
  <p style="font-size:11px;color:#A3A3A3;">Project R &middot; Gest&#227;o desportiva</p>
</body>
</html>`;

  const text = `Project R — Consentimento parental pendente
  ...
  try {
    resendRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: staffEmails,
        subject: "Project R — Consentimento parental pendente",
        html,
        text,
      }),
